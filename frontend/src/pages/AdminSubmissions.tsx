        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <table className="w-full text-sm">
              ...
              <tbody>
                {filtered.map(c => (
                  <tr key={c._id} className={`border-b border-gray-50 hover:bg-gray-50 transition-colors ${c.status === "unread" ? "bg-purple-50/40" : ""}`}>
                    ...
                    <td className="py-3 px-4">
                      <div className="flex gap-2 items-center">
                        ...
                        <select
                          ...
                          className="px-2 py-1 rounded-lg border border-gray-200 text-xs font-medium focus:outline-none focus:border-purple-400 capitalize"
                        >
